...
urlpatterns = [
    ...
    path("admin/export_feedback/", hod_views.admin_export_feedback_csv,
         name='admin_export_feedback'),
    ...
    path("student/export_feedback/", student_views.student_export_feedback_csv,
         name='student_export_feedback'),
